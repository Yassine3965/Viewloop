        ...
        <main className="container mx-auto max-w-4xl py-12 md:py-20">
            ...
            <div className="bg-muted/30 p-8 rounded-2xl border border-border">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    ViewLoop يتبنى نهج "الخادم المرجعي" (Server-Authoritative)، حيث يتم معالجة كافة القواعد والمنطق في بيئة سحابية آمنة. الإضافة تعمل كجهاز طرفي خامل (Passive Device) لا يتدخل في محتوى الصفحات أو خصوصية المستخدم، بل يكتفي بنقل حالة النشاط العامة لضمان دقة التقارير.
                </p>
            </div>
        </main>
    );
